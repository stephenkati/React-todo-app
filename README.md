 ...
 **[React Todo App]** is a web app that lets users create a list of items they aim to achieve. They can mark them as complete and remove completed tasks.
...
go to https://github.com/stephenkati/React-todo-app.git
...
Run `git clone https://github.com/stephenkati/React-todo-app.git`
...
Feel free to check the [issues page](https://github.com/stephenkati/React-todo-app/issues).
